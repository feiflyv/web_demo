	...
	<div class="navbar-container">
		...
		<div class="navbar-header pull-left">
			<a href="#" class="navbar-brand">
				<small>
					<img height="45" src="${img}/logo.png" alt="">
				</small>
			</a>
		</div>
		<!-- /Navbar Barnd -->
		...
		<div class="navbar-header pull-right">
			<div class="navbar-account">
				<ul class="account-area">
					...
					<li>
						<a class="dropdown-toggle" data-toggle="dropdown" title="Mails"
							href="#">
						...
						<ul
							...
							<li>
								<a href="#">
									<img src="./Dashboard_files/divyia.jpg" class="message-avatar"
										alt="Divyia Austin">
									<div class="message">
										<span class="message-sender"> Divyia Austin </span>
										<span class="message-time"> 2 minutes ago </span>
										<span class="message-subject"> Here's the recipe for
											apple pie </span>
										<span class="message-body"> to identify the sending
											application when the senders image is shown for the main icon
										</span>
									</div>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="./Dashboard_files/bing.png" class="message-avatar"
										alt="Microsoft Bing">
									<div class="message">
										<span class="message-sender"> Bing.com </span>
										<span class="message-time"> Yesterday </span>
										<span class="message-subject"> Bing Newsletter: The
											January Issue‏ </span>
										<span class="message-body"> Discover new music just in
											time for the Grammy® Awards. </span>
									</div>
								</a>
							</li>
							<li>
								<a href="#">
									...
									<div class="message">
										...
										<span class="message-body"> The 4K revolution has come
					...
					<li>
						<a class="dropdown-toggle" data-toggle="dropdown" title="Tasks"
							href="#">
					...
					<li>
						...
						<ul
							...
							<li class="dropdown-footer">
								<a href="${context}/public/logout">退出登录</a>
							</li>
						</ul>
						<!--/Login Area Dropdown-->
					</li>
